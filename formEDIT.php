...
if (isset($_POST['form_method_abort_1'])) {
    $form_method_abort_1 = $_POST['form_method_abort_1'];
    $_SESSION['form_method_abort_1'] = $form_method_abort_1;
}
...
if (isset($_POST['form_method_abort_2'])) {
    $form_method_abort_2 = $_POST['form_method_abort_2'];
    $_SESSION['form_method_abort_2'] = $form_method_abort_2;
}
...
if (isset($_POST['form_method_abort_3'])) {
    $form_method_abort_3 = $_POST['form_method_abort_3'];
    $_SESSION['form_method_abort_3'] = $form_method_abort_3;
}
...
if (isset($_SESSION['form_method_abort_1'])) {
    $form_method_abort_1 = $_SESSION['form_method_abort_1'];
}
...
if (isset($_SESSION['form_method_abort_2'])) {
    $form_method_abort_2 = $_SESSION['form_method_abort_2'];
}
...
if (isset($_SESSION['form_method_abort_3'])) {
    $form_method_abort_3 = $_SESSION['form_method_abort_3'];
}
...
form_employment='$form_employment', 
form_height='$form_height', 
form_weight='$form_weight', 
form_hand='$form_hand', 
form_blood='$form_blood', 
form_implant='$form_implant', 
form_diu='$form_diu',
form_risk_notes='$form_risk_notes',
form_anemy='$form_anemy',
form_diabetes='$form_diabetes',
form_transfusion='$form_transfusion',
form_hipertension='$form_hipertension',
form_cancer='$form_cancer',
form_dislexia='$form_dislexia',
form_waist='$form_waist',
form_migraine='$form_migraine',
form_smoke='$form_smoke',
form_smoke_times='$form_smoke_times',
form_smoke_qty='$form_smoke_qty',
form_alcohol='$form_alcohol',
form_alcohol_freq='$form_alcohol_freq',
...
form_alergies='$form_alergies',
form_description_auto='$form_description_auto',
form_description_others='$form_description_others',
form_covid_vaccines='$form_covid_vaccines',
form_reason='$form_reason',
form_adiction='$form_adiction',
form_prison='$form_prison',
form_license='$form_license',
form_car='$form_car',
form_pregnancy_description='$form_pregnancy_description',
form_ectopic_pregnancy='$form_ectopic_pregnancy',
form_last_pregnancy='$form_last_pregnancy',
form_last_birth='$form_last_birth'
WHERE id = $id";
...
$query2 = "UPDATE pregnants SET
form_type_pregnant_1='$form_type_pregnant_1',
form_height_pregnant_1='$form_height_pregnant_1',
form_weight_pregnant_1='$form_weight_pregnant_1',
form_term_pregnant_1='$form_term_pregnant_1',
form_week_pregnant_1='$form_week_pregnant_1',
form_year_pregnant_1='$form_year_pregnant_1',
form_comments_pregnant_1='$form_comments_pregnant_1',
form_type_pregnant_2='$form_type_pregnant_2',
form_height_pregnant_2='$form_height_pregnant_2',
form_weight_pregnant_2='$form_weight_pregnant_2',
form_term_pregnant_2='$form_term_pregnant_2',
form_week_pregnant_2='$form_week_pregnant_2',
form_year_pregnant_2='$form_year_pregnant_2',
form_comments_pregnant_2='$form_comments_pregnant_2',
form_type_pregnant_3='$form_type_pregnant_3',
form_height_pregnant_3='$form_height_pregnant_3',
form_weight_pregnant_3='$form_weight_pregnant_3',
form_term_pregnant_3='$form_term_pregnant_3',
form_week_pregnant_3='$form_week_pregnant_3',
form_year_pregnant_3='$form_year_pregnant_3',
form_comments_pregnant_3='$form_comments_pregnant_3',
form_type_pregnant_4='$form_type_pregnant_4',
form_height_pregnant_4='$form_height_pregnant_4',
form_weight_pregnant_4='$form_weight_pregnant_4',
form_term_pregnant_4='$form_term_pregnant_4',
form_week_pregnant_4='$form_week_pregnant_4',
form_year_pregnant_4='$form_year_pregnant_4',
form_comments_pregnant_4='$form_comments_pregnant_4',
form_type_pregnant_5='$form_type_pregnant_5',
form_height_pregnant_5='$form_height_pregnant_5',
form_weight_pregnant_5='$form_weight_pregnant_5',
form_term_pregnant_5='$form_term_pregnant_5',
form_week_pregnant_5='$form_week_pregnant_5',
form_year_pregnant_5='$form_year_pregnant_5',
form_comments_pregnant_5='$form_comments_pregnant_5',
form_type_pregnant_6='$form_type_pregnant_6',
form_height_pregnant_6='$form_height_pregnant_6',
form_weight_pregnant_6='$form_weight_pregnant_6',
form_term_pregnant_6='$form_term_pregnant_6',
form_week_pregnant_6='$form_week_pregnant_6',
form_year_pregnant_6='$form_year_pregnant_6',
form_comments_pregnant_6='$form_comments_pregnant_6',
form_type_abort_1='$form_type_abort_1',
form_year_abort_1='$form_year_abort_1',
form_method_abort_1='$form_method_abort_1',
form_week_abort_1='$form_week_abort_1',
form_comments_abort_1='$form_comments_abort_1',
form_type_abort_2='$form_type_abort_2',
form_year_abort_2='$form_year_abort_2',
form_method_abort_2='$form_method_abort_2',
form_week_abort_2='$form_week_abort_2',
form_comments_abort_2='$form_comments_abort_2',
form_type_abort_3='$form_type_abort_3',
form_year_abort_3='$form_year_abort_3',
form_method_abort_3='$form_method_abort_3',
form_week_abort_3='$form_week_abort_3',
form_comments_abort_3='$form_comments_abort_3',
form_coded_comments_pregnant_1='$form_1',
form_coded_comments_pregnant_2='$form_2',
form_coded_comments_pregnant_3='$form_3',
form_coded_comments_pregnant_4='$form_4',
form_coded_comments_pregnant_5='$form_5',
form_coded_comments_pregnant_6='$form_6',
form_age_pregnant_1='$form_age_pregnant_1',
form_age_pregnant_2='$form_age_pregnant_2',
form_age_pregnant_3='$form_age_pregnant_3',
form_age_pregnant_4='$form_age_pregnant_4',
form_age_pregnant_5='$form_age_pregnant_5',
form_age_pregnant_6='$form_age_pregnant_6',
form_genre_pregnant_1='$form_genre_pregnant_1',
form_genre_pregnant_2='$form_genre_pregnant_2',
form_genre_pregnant_3='$form_genre_pregnant_3',
form_genre_pregnant_4='$form_genre_pregnant_4',
form_genre_pregnant_5='$form_genre_pregnant_5',
form_genre_pregnant_6='$form_genre_pregnant_6',
form_type_pregnant_s_1='$form_type_pregnant_s_1',
form_height_pregnant_s_1='$form_height_pregnant_s_1',
form_weight_pregnant_s_1='$form_weight_pregnant_s_1',
form_term_pregnant_s_1='$form_term_pregnant_s_1',
form_week_pregnant_s_1='$form_week_pregnant_s_1',
form_year_pregnant_s_1='$form_year_pregnant_s_1',
form_comments_pregnant_s_1='$form_comments_pregnant_s_1',
form_type_pregnant_s_2='$form_type_pregnant_s_2',
form_height_pregnant_s_2='$form_height_pregnant_s_2',
form_weight_pregnant_s_2='$form_weight_pregnant_s_2',
form_term_pregnant_s_2='$form_term_pregnant_s_2',
form_week_pregnant_s_2='$form_week_pregnant_s_2',
form_year_pregnant_s_2='$form_year_pregnant_s_2',
form_comments_pregnant_s_2='$form_comments_pregnant_s_2',
form_type_pregnant_s_3='$form_type_pregnant_s_3',
form_height_pregnant_s_3='$form_height_pregnant_s_3',
form_weight_pregnant_s_3='$form_weight_pregnant_s_3',
form_term_pregnant_s_3='$form_term_pregnant_s_3',
form_week_pregnant_s_3='$form_week_pregnant_s_3',
form_year_pregnant_s_3='$form_year_pregnant_s_3',
form_comments_pregnant_s_3='$form_comments_pregnant_s_3',
form_age_pregnant_s_1='$form_age_pregnant_s_1',
form_age_pregnant_s_2='$form_age_pregnant_s_2',
form_age_pregnant_s_3='$form_age_pregnant_s_3',
form_genre_pregnant_s_1='$form_genre_pregnant_s_1',
form_genre_pregnant_s_2='$form_genre_pregnant_s_2',
form_genre_pregnant_s_3='$form_genre_pregnant_s_3'
WHERE candidateId = $id";
$result2 = mysqli_query($conn, $query2);

$query3 = "UPDATE family SET
family_alergy='$family_alergy',
family_apoplejia='$family_apoplejia',				
family_cardiopathy='$family_cardiopathy',				
family_catarata='$family_catarata',				
family_cirrosis='$family_cirrosis',				
family_convulsive='$family_convulsive',				
family_distrophy='$family_distrophy',				
family_enfisem='$family_enfisem',				
family_epilepsy='$family_epilepsy',				
family_glaucom='$family_glaucom',				
family_hemofilia='$family_hemofilia',				
family_ictericia='$family_ictericia',				
family_migraine='$family_migraine',				
family_varicocele='$family_varicocele',				
family_equinovaro='$family_equinovaro',				
family_mental='$family_mental',				
family_drugs='$family_drugs',				
family_esquizo='$family_esquizo',				
family_alcohol='$family_alcohol',				
family_diabetes_young='$family_diabetes_young',				
family_bocio='$family_bocio',				
family_blind='$family_blind',				
family_daltonic='$family_daltonic',				
family_diabetes='$family_diabetes',				
family_psiquiatric='$family_psiquiatric',				
family_endometriosis='$family_endometriosis',				
family_fibrosis='$family_fibrosis',				
family_gota='$family_gota',				
family_hipertension='$family_hipertension',				
family_paladar='$family_paladar',				
family_kidney='$family_kidney',				
family_circulation='$family_circulation',				
family_psoriasis='$family_psoriasis',				
family_deaf='$family_deaf',				
family_alzheimer='$family_alzheimer',				
family_parkinson='$family_parkinson'
WHERE candidateId = $id";
...
<main class="home">
    <section class="temporary">
        <?php if ($result1 == 1 && $result2 == 1 && $result3 == 1) {
            header("Location: profile_adm.php?msg=El usuario '" . $form_name . "' se ha actualizado exitosamente");
        } ?>
    </section>
</main>
